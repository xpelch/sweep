  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="fc:frame"
          content={`{"version":"vNext","imageUrl":"${APP_OG_IMAGE_URL}","button":{"title":"🚩 Start","action":{"type":"launch_frame","url":"${APP_URL}","name":"${APP_NAME}","splashImageUrl":"${APP_ICON_URL}","splashBackgroundColor":"#f5f0ec"}}}`}
        />
      </head>
      <body>
